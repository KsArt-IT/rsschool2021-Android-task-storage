...
class PotatoDatabaseInitial {
    ...
    val potatoInitData: List<Potato> = listOf(
        Potato(
            id = 1,
            name = "Адретта",
            description = "Картофель имеет великолепные вкусовые качества, хотя изначально сорт создавался как кормовая разновидность, поскольку имеет желтый цвет кожуры.$13$10Сорт «Адретта» был выведен германскими селекционерами не так давно (около 25 лет назад), но сразу был по достоинству оценен гурманами, поэтому быстро приобрел популярность и стал широко использоваться в кулинарии благодаря своим высоким вкусовым качествам.",
            imageUri = null,
